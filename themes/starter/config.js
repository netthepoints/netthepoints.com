...
const CONFIG = {
  ...
  STARTER_LOGO: '/images/starter/logo/20241115-145829.svg', // 普通logo图片 示例：/images/starter/logo/logo.svg
  STARTER_LOGO_WHITE: '/images/starter/logo/newlogo_white.svg', // 透明底浅色logo 示例： /images/starter/logo/logo-white.svg
  ...
  STARTER_HERO_TITLE_2: 'Your bicycle components project manager: professional process to fully protect your project.', // 英雄区文字
  ...
  // 英雄区配图，如需隐藏，改为空值即可 ''
  STARTER_HERO_PREVIEW_IMAGE: 'images/starter/hero/workflow.webp', // 产品预览图 ，默认读取public目录下图片
  ...
  STARTER_ABOUT_TITLE: '',
  STARTER_ABOUT_TEXT:
    '<strong class=font-bold text-black-500>Appointment of an Outstanding Project General Manager</strong><br/>After you place an order, we will immediately appoint an experienced sales engineer as the general manager for your project. This general manager will be fully responsible for overseeing and coordinating all aspects of the project and will be your exclusive direct contact person, ensuring smooth communication for your project.<br/><br/><strong class=font-bold text-black-500>Selection of an Elite R & D Expert Group</strong><br/>Based on the development requirements of customers, we carefully select the most suitable designers and engineers to form a professional R & D team. They will inject strong technical impetus into your project with outstanding professional capabilities and innovative thinking.<br/><br/><strong class=font-bold text-black-500>Selection of Adaptable Production and Logistics Teams</strong><br/>According to the processes required by the product, we strictly select appropriate production and logistics teams. The production team ensures high - quality production of the product, and the logistics team ensures the safe and timely delivery of the product, fully meeting the requirements of your project.<br/><br/><strong class=font-bold text-black-500>Project General Manager Initiates Project Promotion</strong><br/>The project general manager will convene all project members to start the project journey and regularly report the progress to you. During the whole process, they will lead the team towards the goal and keep you informed of the project status at all times.',
