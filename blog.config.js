...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'NTP (Net The Points) is dedicated to providing customers with a one-stop solution for high-quality carbon fiber bicycle components. We are your bicycle components project manager.',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Net The Points', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'We are your bicycle components project manager.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.netthepoints.com/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Bicycle parts，carbon fiber', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'netthepoints@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || '', // 你的github个人主页 例如 https://github.com/tangly1024
  CONTACT_TELEGRAM: process.env.NEXT_PUBLIC_CONTACT_TELEGRAM || '', // 你的telegram 地址 例如 https://t.me/tangly_1024
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || 'https://www.linkedin.com/company/net-the-points', // 你的linkedIn 首页
  ...
  FONT_URL: [
    // 'https://fonts.cdnfonts.com/css/michroma',
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,wechat,qq,weibo,email(netthepoints@gmail.com),facebook（https://www.facebook.com/profile.php?id=61566045458288）,twitter,telegram,messenger,line,reddit,whatsapp(+86 137 9925 1201),linkedin(https://www.linkedin.com/company/net-the-points)', // 分享的服務，按顺序显示,逗号隔开
  ...
  MAILCHIMP_LIST_ID: process.env.MAILCHIMP_LIST_ID || false, // 开启mailichimp邮件订阅 客户列表ID ，具体使用方法参阅文档
