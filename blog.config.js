...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'We will assist you in locating the most suitable supplier tailored to your specific needs.',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Lets Net The Points to capture the essence of value in sourcing solutions by connecting all relevant parties.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.netthepoints.com/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Bicycle parts, Sourcing, Supplier network', // 网站关键词 英文逗号隔开
  ...
  CONTACT_LINKEDIN: process.env.NEXT_PUBLIC_CONTACT_LINKEDIN || 'www.linkedin.com/in/hayson-netthepoints', // 你的linkedIn 首页
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,wechat,qq,weibo,email(netthepoints@gmail.com),facebook（https://www.facebook.com/profile.php?id=61566045458288）,twitter,telegram,messenger,line,reddit,whatsapp(+86 137 9925 1201),linkedin(www.linkedin.com/in/hayson-netthepoints)', // 分享的服務，按顺序显示,逗号隔开
