...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Although we may not be the leading option, we are deeply committed to understanding your needs and providing the optimal solution within the constraints of your demands and budget.', // 作者简介
